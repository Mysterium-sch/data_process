...
class Kitti:
    ...
    def __init__(self, frame='all', velo_path=None, camera_path=None, \
        ...
        if xml_path is not None:
            ...
            self.__tracklet_box, self.__tracklet_type, self.descrption = self.__load_tracklet()
        else:
            self.__xml_path = None
            self.__tracklet_box, self.__tracklet_type, self.descrption = None, None, None
    ...
    def tracklet_info(self):
        return self.__tracklet_box, self.__tracklet_type, self.descrption
    ...
    def __load_tracklet(self):
        ...
        for tracklet in tracklets:
            ...
            for translation, rotation, state, occlusion, truncation, amtOcclusion, amtBorders, absoluteFrameNumber in tracklet:
                ...
                text = str(tracklet.objectType) + " " + str(truncation) + " " + str(occlusion[0]) + " " + \
                    str(round(w, 2)) + " " + str(round(h, 2)) + " " + str(round(l, 2)) + " " + str(round(yaw, 2)) + " " 
                ...
                if absoluteFrameNumber in f_tracklet:
                    ...
                    description[absoluteFrameNumber] += [text]
                else:
                    f_tracklet[absoluteFrameNumber] = [cornerPosInVelo]
                    f_type[absoluteFrameNumber] = [tracklet.objectType]
                    description[absoluteFrameNumber] = [text]
        ...
        return f_tracklet, f_type, description 
